...
define half @__extract_half(<WIDTH x half>, i32) nounwind readnone alwaysinline {
  %extract = extractelement <WIDTH x half> %0, i32 %1
  ret half %extract
}

define <WIDTH x half> @__insert_half(<WIDTH x half>, i32,
                                     half) nounwind readnone alwaysinline {
  %insert = insertelement <WIDTH x half> %0, half %2, i32 %1
  ret <WIDTH x half> %insert
}

define float @__extract_float(<WIDTH x float>, i32) nounwind readnone alwaysinline {
  %extract = extractelement <WIDTH x float> %0, i32 %1
  ret float %extract
}

define <WIDTH x float> @__insert_float(<WIDTH x float>, i32,
                                     float) nounwind readnone alwaysinline {
  %insert = insertelement <WIDTH x float> %0, float %2, i32 %1
  ret <WIDTH x float> %insert
}

define double @__extract_double(<WIDTH x double>, i32) nounwind readnone alwaysinline {
  %extract = extractelement <WIDTH x double> %0, i32 %1
  ret double %extract
}

define <WIDTH x double> @__insert_double(<WIDTH x double>, i32,
                                     double) nounwind readnone alwaysinline {
  %insert = insertelement <WIDTH x double> %0, double %2, i32 %1
  ret <WIDTH x double> %insert
}
