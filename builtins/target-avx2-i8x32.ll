...
define i32 @__cast_mask_to_i32 (<WIDTH x MASK> %mask) alwaysinline {
  %m = call i32 @llvm.x86.avx2.pmovmskb(<32 x i8> %mask)
  ret i32 %m
}
...
define <32 x float> @__half_to_float_varying(<32 x i16> %v) nounwind readnone {
  v32tov8(i16, %v, %v0, %v1, %v2, %v3)
  %r0 = call <8 x float> @llvm.x86.vcvtph2ps.256(<8 x i16> %v0)
  %r1 = call <8 x float> @llvm.x86.vcvtph2ps.256(<8 x i16> %v1)
  %r2 = call <8 x float> @llvm.x86.vcvtph2ps.256(<8 x i16> %v2)
  %r3 = call <8 x float> @llvm.x86.vcvtph2ps.256(<8 x i16> %v3)
  v8tov32(float, %r0, %r1, %r2, %r3, %r)
  ret <32 x float> %r
}

define <32 x i16> @__float_to_half_varying(<32 x float> %v) nounwind readnone {
  ...
  %r2 = call <8 x i16> @llvm.x86.vcvtps2ph.256(<8 x float> %v2, i32 0)
  %r3 = call <8 x i16> @llvm.x86.vcvtps2ph.256(<8 x float> %v3, i32 0)
  v8tov32(i16, %r0, %r1, %r2, %r3, %r)
  ret <32 x i16> %r
}
...
define <32 x float> @__floor_varying_float(<32 x float> %v) nounwind readonly alwaysinline {
  ...
  %r2 = call <8 x float> @llvm.floor.v8f32(<8 x float> %v2)
  %r3 = call <8 x float> @llvm.floor.v8f32(<8 x float> %v3)
  v8tov32(float, %r0, %r1, %r2, %r3, %r)
  ret <32 x float> %r
}
...
define <32 x float> @__ceil_varying_float(<32 x float> %v) nounwind readonly alwaysinline {
  ...
  %r2 = call <8 x float> @llvm.ceil.v8f32(<8 x float> %v2)
  %r3 = call <8 x float> @llvm.ceil.v8f32(<8 x float> %v3)
  v8tov32(float, %r0, %r1, %r2, %r3, %r)
  ret <32 x float> %r
}
...
define <32 x double> @__floor_varying_double(<32 x double> %v) nounwind readonly alwaysinline {
  ...
  %r4 = call <4 x double> @llvm.floor.v4f64(<4 x double> %v4)
  %r5 = call <4 x double> @llvm.floor.v4f64(<4 x double> %v5)
  %r6 = call <4 x double> @llvm.floor.v4f64(<4 x double> %v6)
  %r7 = call <4 x double> @llvm.floor.v4f64(<4 x double> %v7)
  v4tov32(double, %r0, %r1, %r2, %r3, %r4, %r5, %r6, %r7, %r)
  ret <32 x double> %r
}
...
define <32 x double> @__ceil_varying_double(<32 x double> %v) nounwind readonly alwaysinline {
  ...
  %r4 = call <4 x double> @llvm.ceil.v4f64(<4 x double> %v4)
  %r5 = call <4 x double> @llvm.ceil.v4f64(<4 x double> %v5)
  %r6 = call <4 x double> @llvm.ceil.v4f64(<4 x double> %v6)
  %r7 = call <4 x double> @llvm.ceil.v4f64(<4 x double> %v7)
  v4tov32(double, %r0, %r1, %r2, %r3, %r4, %r5, %r6, %r7, %r)
  ret <32 x double> %r
}
...
declare <32 x float> @llvm.sqrt.v32f32(<32 x float> %Val)
define <32 x float> @__sqrt_varying_float(<32 x float> %v) nounwind readnone alwaysinline {
  %r = call <32 x float> @llvm.sqrt.v32f32(<32 x float> %v)
  ret <32 x float> %r
}
...
declare <32 x double> @llvm.sqrt.v32f64(<32 x double> %Val)
define <32 x double> @__sqrt_varying_double(<32 x double> %v) nounwind readnone alwaysinline {
  %r = call <32 x double> @llvm.sqrt.v32f64(<32 x double> %v)
  ret <32 x double> %r
}
...
define <32 x float> @__rsqrt_varying_float(<32 x float> %v) nounwind readnone alwaysinline {
  %r0 = call <32 x float> @llvm.sqrt.v32f32(<32 x float> %v)
  %r = fdiv <32 x float> <float 1., float 1., float 1., float 1., float 1., float 1., float 1., float 1., float 1., float 1., float 1., float 1., float 1., float 1., float 1., float 1.,
