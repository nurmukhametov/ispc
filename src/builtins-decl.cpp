...
DECL_BUILTIN_NAME(__atomic_fadd_float_global);
DECL_BUILTIN_NAME(__atomic_fadd_uniform_float_global);
DECL_BUILTIN_NAME(__atomic_fadd_double_global);
DECL_BUILTIN_NAME(__atomic_fadd_uniform_double_global);
DECL_BUILTIN_NAME(__atomic_fsub_float_global);
DECL_BUILTIN_NAME(__atomic_fsub_uniform_float_global);
DECL_BUILTIN_NAME(__atomic_fsub_double_global);
DECL_BUILTIN_NAME(__atomic_fsub_uniform_double_global);
DECL_BUILTIN_NAME(__atomic_fmax_float_global);
DECL_BUILTIN_NAME(__atomic_fmax_uniform_float_global);
DECL_BUILTIN_NAME(__atomic_fmax_double_global);
DECL_BUILTIN_NAME(__atomic_fmax_uniform_double_global);
DECL_BUILTIN_NAME(__atomic_fmin_float_global);
DECL_BUILTIN_NAME(__atomic_fmin_uniform_float_global);
DECL_BUILTIN_NAME(__atomic_fmin_double_global);
DECL_BUILTIN_NAME(__atomic_fmin_uniform_double_global);
